...
export default function NewSupplierScreen() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Supplier has no `type` column (suppliers are always suppliers). Opening
      // balance seeds currentBalance so the payable ledger starts from the right
      // number, exactly like a new customer's opening balance.
